...
{
    text: "彼らの姿は暗闇に溶け込み、光るモニターに照らされた指先だけが動きを見せていた。",
    bg: "bg1",
    speed: 0.4,
    audio: "shadow3.m4a",
    lines: 1
...
{
    text: "モニターには複雑なコードと途方もない数字が青く浮かび上がり、冷たい光を放っていた。",
    bg: "bg1",
    speed: 0.4,
    audio: "shadow3.m4a",
    lines: 2
...
{
    text: "前回とは違って、資金を分配する前にミキシングサービスを通して経路を隠す。",
    bg: "bg1",
    speed: 0.3,
    audio: "shadow3.m4a",
    lines: 2
...
{
    speaker: "ALL SHADOWS",
    text: "コードを読める奴はいても、その背後に隠された『氣』の流れを見ることができる奴はいないからだ。",
    bg: "bg1",
    speed: 0.3,
    audio: "shadow3.m4a",
    lines: 2
...
{
    text: "夜空には満月がぽっかりと浮かび、神秘的な光を放っていた。",
    bg: "bg2",
    speed: 0.4,
    audio: "moonlight1.m4a",
    lines: 2
...
{
    text: "RYOCHANはひんやりとした空気を感じながら、古い神社の石段の前に立っていた。",
    bg: "bg2",
    speed: 0.4,
    audio: "moonlight1.m4a",
    lines: 2
...
{
    text: "風が桜の花びらをひらひらと舞わせ、その花びらは月光に照らされて幻想的な光景を作り出していた。",
    bg: "bg2",
    speed: 0.4,
    audio: "moonlight1.m4a",
    lines: 2
...
{
    text: "17歳とは思えないほど、その瞳には深い知識と、失われつつある何かを守ろうとする強い意志の光が宿っていた。",
    bg: "bg3",
    speed: 0.4,
    audio: "sakura1.m4a",
    lines: 2
...
{
    speaker: "SAKURA",
    text: "私はサクラ。高校生だけど、祖父から日本の古代文化について教わってきたの。",
    bg: "bg3",
    speed: 0.3,
    audio: "sakura1.m4a",
    lines: 2
...
{
    text: "特に『氣』という概念を現代にどう活かせるか、ずっと考えているのよ。",
    bg: "bg3",
    speed: 0.3,
    audio: "sakura1.m4a",
    lines: 2
...
{
    speaker: "SAKURA",
    text: "やはりそうなのね！祖父が神社の管理人だった時からずっと言っていたの。",
    bg: "bg3",
    speed: 0.3,
    audio: "sakura1.m4a",
    lines: 2
...
{
    text: "『いつか満月の夜に、失われた『氣』を視る力を持つ守護者が現れる』って。",
    bg: "bg3",
    speed: 0.3,
    audio: "sakura1.m4a",
    lines: 2
...
{
    text: "ブロックチェーンという革新的な技術を使って、人々の資産を奪おうとしている。",
    bg: "bg4",
    speed: 0.3,
    audio: "sakura1.m4a",
    lines: 2
...
{
    text: "私たち研究者が分析しても、表面的には何の問題もないように見せかけているの。",
    bg: "bg4",
    speed: 0.3,
    audio: "sakura1.m4a",
    lines: 2
...
{
    speaker: "SAKURA",
    text: "あなたの目には、コードの背後に隠された悪意の『氣』が見えるはず。",
    bg: "bg4",
    speed: 0.3,
    audio: "sakura1.m4a",
    lines: 2
...
{
    text: "それは普通の人間には感知できない、現代の悪霊とも言えるものよ。",
    bg: "bg4",
    speed: 0.3,
    audio: "sakura1.m4a",
    lines: 2
...
{
    speaker: "SAKURA",
    text: "祖父から聞いた話では、戦後の教育改革で日本人の精神性に大きな変化が起きたの。",
    bg: "bg4",
    speed: 0.3,
    audio: "sakura1.m4a",
    lines: 2
...
{
    text: "つまり、日本人の持つ本来の力が意図的に封じ込められたということなの。",
    bg: "bg4",
    speed: 0.3,
    audio: "sakura1.m4a",
    lines: 2
...
{
    speaker: "SAKURA",
    text: "学校教育からも、『氣』の概念は徐々に消されていった。\n代わりに物質的な豊かさや競争を重視する価値観が植え付けられていったのよ。",
    bg: "bg4",
    speed: 0.3,
    audio: "sakura1.m4a",
    lines: 2
...
{
    speaker: "SAKURA",
    text: "現代の詐欺師たちは、そうして心の『氣』を失った人々の隙間を狙っている。",
    bg: "bg4",
    speed: 0.3,
    audio: "sakura1.m4a",
    lines: 2
...
{
    text: "本来の直感力を失った人々は、偽りの希望に騙されやすくなっているのよ。",
    bg: "bg4",
    speed: 0.3,
    audio: "sakura1.m4a",
    lines: 2
...
{
    speaker: "SAKURA",
    text: "でもあなたの力があれば、真実と偽りを見分けることができる。",
    bg: "bg4",
    speed: 0.3,
    audio: "sakura1.m4a",
    lines: 2
...
{
    text: "サクラは再びノートパソコンを開き、慎重に画面をRYOCHANに向けた。",
    bg: "bg4",
    speed: 0.4,
    audio: "sakura1.m4a",
    lines: 2,
...
{
    speaker: "SAKURA",
    text: "これが問題のプロジェクト。『Future Finance』",
    bg: "bg4",
    speed: 0.3,
    audio: "sakura1.m4a",
    lines: 2
...
{
    text: "一見すると次世代の分散型金融プラットフォームに見え、投資家に高い利回りを約束している。",
    bg: "bg4",
    speed: 0.3,
    audio: "sakura1.m4a",
    lines: 2
...
{
    text: "普通の文字とコードの間に、血のように赤い『氣』の流れが見えた。",
    bg: "bg5",
    speed: 0.4,
    audio: "ryoscan1.m4a",
    lines: 2
...
{
    text: "それは蛇のようにコードの中を這い回り、特定の関数に集中していた。",
    bg: "bg5",
    speed: 0.4,
    audio: "ryoscan1.m4a",
    lines: 2
...
{
    text: "表面は美しく装っているけど、内部には恐ろしい悪意が渦巻いている。",
    bg: "bg6",
    speed: 0.3,
    audio: "ryoscan1.m4a",
    lines: 2
...
{
    text: "それは投資家たちの資金を特定のウォレットに自動転送する仕組み。",
    bg: "bg6",
    speed: 0.3,
    audio: "ryoscan1.m4a",
    lines: 2
...
{
    speaker: "SAKURA",
    text: "信じられない...私たちが何週間かけても見つけられなかった隠し関数が...",
    bg: "bg4",
    speed: 0.3,
    audio: "ryoscan1.m4a",
    lines: 2
...
{
    speaker: "SAKURA",
    text: "そうよ！古代の知恵と現代の技術を一緒に使えたらいいなって思ってたの。",
    bg: "bg8",
    speed: 0.3,
    audio: "ryoscan1.m4a",
    lines: 2
...
{
    text: "サクラの指が最後のエンターキーを押した瞬間、画面が静かに切り替わった。",
    bg: "bg7",
    speed: 0.4,
    audio: "ryoscan1.m4a",
    lines: 2
...
{
    text: "彼女の瞳に、淡いターコイズブルーの光が反射する。ノートパソコンのディスプレイには、『RYO SCAN』と名付けられたプロトタイプが起動していた。",
    bg: "bg7",
    speed: 0.4,
    audio: "ryoscan1.m4a",
    lines: 2
...

{
    ...
    text: "青、緑、黄色、赤——まるで子供が描いた太陽系のように、素朴で、しかしどこか愛らしい。",
    bg: "bg7",
    speed: 0.4,
    audio: "ryoscan1.m4a",
    lines: 2
...
{
    text: "日本古来の『和』の精神と『衆善奉公』の心を込めたの。",
    bg: "bg7",
    speed: 0.3,
    audio: "ryoscan1.m4a",
    lines: 2
...
{
    text: "あなたが危険を察知したら、システムがその情報を美しく、わかりやすく整理して",
    bg: "bg7",
    speed: 0.3,
    audio: "ryoscan1.m4a",
    lines: 2
...
{
    text: "サクラはRYOCHANの指示に従い、詳細な分析レポートを作成していく。",
    bg: "bg8",
    speed: 0.4,
    audio: "ryoscan1.m4a",
    lines: 2
...
{
    text: "しかもこの警告方法なら、恐怖を煽るのではなく、教育的で建設的。",
    bg: "bg8",
    speed: 0.3,
    audio: "ryoscan1.m4a",
    lines: 2
...
{
    text: "レポートには詐欺の手法だけでなく、安全な投資の見分け方も含まれていた。",
    bg: "bg8",
    speed: 0.4,
    audio: "ryoscan1.m4a",
    lines: 2
...
{
    text: "それは単なる警告ではなく、金融リテラシーを高める教材でもあった。",
    bg: "bg8",
    speed: 0.4,
    audio: "ryoscan1.m4a",
    lines: 2
...
{
    speaker: "SAKURA",
    text: "送信完了...すごいわ。RYOCHANのおかげで、多くの人々の大切な資産を守ることができるかも。",
    bg: "bg8",
    speed: 0.3,
    audio: "ryoscan1.m4a",
    lines: 2
...
{
    text: "『日本発の新しい金融セキュリティ技術として世界に広めていきましょう』",
    bg: "bg10",
    speed: 0.3,
    audio: "success1.m4a",
    lines: 2
...
{
    text: "ディスプレイには彼らのプロジェクトに関する詳細な警告レポートが表示されていた。",
    bg: "bg12",
    speed: 0.4,
    audio: "shadow4.m4a",
    lines: 2
...
{
    text: "それは単なる告発ではなく、教育的で建設的な内容だった。",
    bg: "bg12",
    speed: 0.4,
    audio: "shadow4.m4a",
    lines: 2
...
{
    text: "投資家たちは恐怖ではなく理解を持って彼らのプロジェクトから離れていったのだ。",
    bg: "bg12",
    speed: 0.4,
    audio: "shadow4.m4a",
    lines: 2
...
{
    text: "彼らの完璧だと思っていた計画をあっさりと見破られていた。",
    bg: "bg11",
    speed: 0.4,
    audio: "shadow4.m4a",
    lines: 2
...
{
    text: "だからこそ、より多くの人々が信頼し、情報を拡散していったのだ。",
    bg: "bg11",
    speed: 0.4,
    audio: "shadow4.m4a",
    lines: 2
...
{
    speaker: "SHADOW 2",
    text: "ありえない...あのコードに隠した罠は最新の難読化技術を使っていたのに...",
    bg: "bg13",
    speed: 0.3,
    audio: "shadow4.m4a",
    lines: 2
...
{
    speaker: "SHADOW 1",
    text: "この『RYO SCAN』とかいうシステムを作った奴らを必ず見つけ出してやる。",
    bg: "bg14",
    speed: 0.3,
    audio: "shadow4.m4a",
    lines: 2
...
{
    text: "そして次のプロジェクトはもっと巧妙に、もっと完璧に作り上げてやる！",
    bg: "bg14",
    speed: 0.3,
    audio: "shadow4.m4a",
    lines: 2
...
{
    text: "その夜、サクラのアパートの窓辺に座ったRYOCHANは、街の明かりを見つめていた。",
    bg: "bg15",
    speed: 0.4,
    lines: 2,
    scene: "scene11",
...
{
    speaker: "SAKURA",
    text: "今日、私たちが成し遂げたことは単なる詐欺の阻止じゃないのよ。",
    bg: "bg16",
    speed: 0.3,
    audio: "sakura2.m4a",
    lines: 2
...
{
    text: "そして何より、一人一人の力が世界を変えることができるという証明よ。",
    bg: "bg16",
    speed: 0.3,
    audio: "sakura2.m4a",
    lines: 2
...
{
    text: "かつて『氣』は『気』に簡略化され、その本質が失われてしまった。",
    bg: "bg15",
    speed: 0.4,
    audio: "sakura2.m4a",
    lines: 2
...
{
    text: "窓の外には都市の明かりが輝き、その光がRYOCHANとサクラの瞳に映り込んでいた。",
    bg: "bg15",
    speed: 0.4,
    audio: "sakura2.m4a",
    lines: 2
...
{
    text: "二人の絆から生まれた新たな物語が、ここから始まろうとしているのね。",
    bg: "bg16",
    speed: 0.3,
    audio: "sakura2.m4a",
    lines: 2
